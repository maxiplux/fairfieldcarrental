...
<main role="main" class="container">
    ...
    <div class="row">
        ...
        <div class="col-12" id="dataset">
            ...
            <form class="form-signin" action="/EditUserController" method="post" id="newuser">
                ...
                <input type="text" name="middlename" id="middlename" class="form-control" value=${user.middleName} placeholder="middle name" required>
                <label for="lastname" class="sr-only">First Name</label>
                <input type="text" name="lastname" id="lastname" class="form-control" value=${user.lastName} placeholder="last name" required>
                <label for="email" class="sr-only">Email address</label>
                <input type="email" name="email" id="email" class="form-control" value=${user.email} placeholder="Email address" required autofocus>
                <label for="password" class="sr-only">Password</label>
                <input type="password" name="password" id="password" class="form-control" value=${user.password} placeholder="Password" required>
